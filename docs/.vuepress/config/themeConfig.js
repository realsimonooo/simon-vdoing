...
module.exports = {
  ...
  // repo: 'realsimonooo', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'Simon(realsimonooo)', // 必需
    link: 'https://github.com/realsimonooo', // 可选的
  },
  blogger: {
    // 博主信息，显示在首页侧边栏
    avatar: 'https://gitee.com/realsimonooo/blog-image/raw/master/uPic/EXjtyY.jpg',
    name: 'realsimonooo',
    slogan: 'status=🤯working/studying',
  },
  social: {
    ...
    icons: [
      {
        ...
        title: 'E-mail',
        link: 'mailto:simonlaw910@gmail.com',
      },
      {
        iconClass: 'icon-github',
        title: 'GitHub',
        link: 'https://github.com/realsimonooo',
      },
      {
        iconClass: 'icon-telegram',
        title: 'Telegram',
        link: 'https://t.me/realsimonooo',
      },
    ],
  },
  footer: {
